      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 relative z-10">
        ...
        <div className="flex items-center gap-4 mb-8">
          ...
          <div>
            ...
            <p className="text-black-300 text-lg">Manage your account and view your activity</p>
          </div>
        </div>
          ...
          <div className="flex flex-col lg:flex-row items-center lg:items-start gap-8">
            ...
            <div className="flex flex-col items-center text-center">
              ...
              <div className="flex items-center gap-2 text-accent-400">
                ...
                <span className="text-sm font-medium">BlogSphere Writer</span>
              </div>
            </div>
                    ...
                    {recentBlogs.slice(0, 5).map((blog, index) => (
                      <div key={blog._id} className="flex items-center gap-3 p-2 bg-black-800/50 rounded-lg border border-black-700">
                        ...
                        <div className="text-right text-xs text-black-400 flex-shrink-0">
                          <p>{getWordCount(blog.content)}w</p>
                          <p>{getReadTime(blog.content)}m</p>
                        </div>
                      </div>
                    ))}
                    {recentBlogs.length === 0 && (
                      <div className="text-center py-4 text-black-400 text-sm">
                        No recent activity
                      </div>
                    )}
                  </div>
