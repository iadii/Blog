  ...
  const benefits = [
    {
      ...
      description: 'Your data is protected with Google\'s industry-leading security.',
    },
    {
      icon: Zap,
    ...
    },
    {
      ...
      description: 'Your own private blogging sanctuary awaits.',
    },
  ];
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-black-950 via-black-900 to-black-950 flex items-center justify-center px-4">
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        <div className="absolute bottom-1/4 right-1/4 w-96 h-96 bg-gold-500/5 rounded-full blur-3xl animate-float" style={{ animationDelay: '1s' }}></div>
      </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              ...
              {benefits.map((benefit, index) => {
                ...
                return (
                  <div key={index} className="flex items-start gap-4">
                    <div className="flex-shrink-0 w-10 h-10 bg-gradient-to-r from-accent-500/20 to-gold-500/20 rounded-lg flex items-center justify-center">
                      <Icon className="w-5 h-5 text-accent-400" />
                    </div>
                    <div>
                      <h3 className="text-white font-bold mb-1">{benefit.title}</h3>
                      <p className="text-black-400 text-sm">{benefit.description}</p>
                    </div>
                  </div>
                );
              })}
          ...
          <div className="flex justify-center lg:justify-end">
            <div className="w-full max-w-md">
              <div className="card bg-black-800/30 backdrop-blur-xl border-black-700">
                <div className="text-center mb-8">
                  <h3 className="text-2xl font-bold text-white mb-2">Sign In</h3>
                  <p className="text-black-300">Continue with your Google account</p>
                </div>

                <button
                  onClick={handleGoogleLogin}
                  className="w-full bg-white hover:bg-gray-50 text-gray-900 font-semibold py-4 px-6 rounded-xl transition-all duration-200 flex items-center justify-center gap-3 shadow-lg hover:shadow-xl transform hover:-translate-y-0.5"
                >
              ...
              <div className="mt-8 text-center">
                <div className="inline-flex items-center gap-2 text-black-400 text-sm">
