          ...
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-6 mb-8">
            ...
            <div className="flex flex-1 items-center gap-4 min-w-0">
              ...
              <select
                ...
                className="bg-black-900/60 border border-white/10 rounded-xl px-6 py-3 pr-8 text-white focus:outline-none focus:border-teal-400 focus:ring-2 focus:ring-teal-400/20 transition flex-shrink-0"
              >
